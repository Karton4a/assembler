...
class TwoOperandCommand : public Mnemonic
{
public:
	TwoOperandCommand() = delete;
	TwoOperandCommand(DataManager::CommandData data, Parser::LexemIterator f_b, Parser::LexemIterator s_b, Parser::LexemIterator e)
